...
const diffWords = (sen1, sen2) => {
  ...
  let wordGroup1 = _.groupBy(sen1, sortFunc),
  ...
  let same_keys = _.intersection(Object.keys(countGroup1), Object.keys(countGroup2));
