...
savedContent.thirdMin = [
  '首先大家不知道有没有做过，这种像这种拉伸的运动，就是用用最长用用你最大的幅度来去勾你的脚ok，等待可以看一下，并且记录一下，你现在可以触碰到的位置',
  '最高的，可以触碰到的最高的限度是多少？对，可能有的同学可以触碰到地面，但是有的同学可能这个由于韧带的问题可能并不会触碰到地面，对，ok，',
  '大家记住自己可以下呀的最大的幅度，所有人都闭上的眼睛，眼球，哦，顺时针转五圈一下用于自己眼球顺时针转五圈，',
  '当你闭上眼睛的时候，重新转五圈眼球的时候再下去，下了的时候你会发现你可以突破你之前的极限。这的一个很有意思的小的实验，第二小的实验大家所有人双脚与肩同宽，然后伸出自己的左手，'
];
